...
public class CorverFileUtils {
    //设置
    private  static String rootPath="MUTA/corver";
    //原始文件(不能播放)
    private final static String AUDIO_PCM_BASEPATH = "/"+rootPath+"/recordpcm/";
    //可播放的高质量音频文件
    private final static String AUDIO_WAV_BASEPATH = "/"+rootPath+"/wav/";

    public static void setRootPath(String rootPath){
        CorverFileUtils.rootPath=rootPath;
    }
